      ...
      if [ -n "$EXISTING_APP" ] && [ "$EXISTING_APP" != "None" ] && [ "$EXISTING_APP" != "null" ]; then
        ...
        CREATE_RESULT=$(az rest --method POST \
          ...
          --body "{
            ...
            echo "=========================================="
            echo ""
            echo "El Managed Identity no tiene permisos de Microsoft Graph API"
            echo "para crear App Registrations."
            echo ""
            ...
            echo "5. Redirect URI: Select 'Single-page application (SPA)'"
            echo "   URL: ${REDIRECT_URI_1}"
            echo "6. Click 'Register'"
            echo "7. Ve a 'Authentication' y agrega otro redirect URI:"
            echo "   ${REDIRECT_URI_2}"
            echo "8. Copia el 'Application (client) ID'"
            echo "9. Actualiza el archivo config.json en el frontend con:"
            echo "   - azureClientId: <tu client id>"
            echo "   - authMode: azure"
            echo ""
            echo "=========================================="
